...
export function EasterEgg() {
  ...
  // High performance unmount delay
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 z-[100000] bg-lime flex flex-col items-center justify-center p-10 cursor-none overflow-hidden transition-opacity duration-500",
    ...
    >
      ...
      <div
        className={cn(
          "text-center relative z-20 transition-all duration-700 ease-out",
          isAnimating ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-10 scale-90"
        )}
      >
