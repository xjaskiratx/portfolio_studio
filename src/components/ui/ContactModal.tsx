...
export function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <div 
      id="modal-bg" 
      className={cn(
        "fixed inset-0 z-[2000] bg-[rgba(5,5,10,0.9)] backdrop-blur-[20px] flex items-center justify-center p-4 md:p-8 transition-opacity duration-500",
    ...
    >
      <div
        className={cn(
          "modal relative bg-[rgba(13,13,21,0.97)] border border-white/10 backdrop-blur-[32px] w-full max-w-[540px] p-8 md:p-12 overflow-hidden transition-all duration-500 ease-out",
      ...
      >
        ...
        <div className="relative overflow-hidden min-h-[340px]">
          ...
          {step === 'done' && (
            <div className="modal-success text-center py-5 animate-fade-in">
